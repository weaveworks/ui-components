...
const WeaveLogoProgress = styled.div`
  ...
  .st0{ fill: ${props => props.theme.colors.primary.charcoal}; }
  .st1{ fill: ${props => props.theme.colors.accent.blue}; }
  .st2{ fill: ${props => props.theme.colors.accent.orange};  }
        ...
        <WeaveLogoProgress>
          <svg>
            <g>
              ...
              <path className="st1 b" d="M83.5,119.9L83.5,119.9l-21.7,19.4v7.9c3.6,0.5,7.3,0.8,11.1,0.8c4.4,0,8.7-0.4,12.9-1.1l58-51.8 c2-6.7,3-13.7,3-21c0-3.4-0.3-6.8-0.7-10.1L83.5,119.9z" />
